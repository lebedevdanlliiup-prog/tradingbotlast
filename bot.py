...
async def handle_callback(callback_query):
    ...
    if data == "back_main":
        ...
        await edit_or_send(chat_id, "Enter number (10-99) for minimum probability threshold:", get_threshold_input_keyboard())
    ...
    if chat_id in waiting_for_threshold:
        try:
            ...
            if 10 <= val <= 99:
                ...
                await edit_or_send(chat_id, "Enter value between 10 and 99.", get_threshold_input_keyboard())
        except:
            await edit_or_send(chat_id, "Please enter a number.", get_threshold_input_keyboard())
        return
