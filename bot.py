...
async def handle_callback(callback_query):
    ...
    if data == "back_main":
        ...
        await send_tg(chat_id, "Enter number (10-99) for minimum probability threshold:", get_threshold_input_keyboard())
        ...
        await send_tg(chat_id, info, get_back_menu_keyboard())
    ...
    if chat_id in waiting_for_threshold:
        ...
        try:
            ...
            if 10 <= val <= 99:
                ...
                await send_tg(chat_id, "Enter value between 10 and 99:", get_threshold_input_keyboard())
        except:
            await send_tg(chat_id, "Please enter a valid number:", get_threshold_input_keyboard())
        return
