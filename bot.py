...
active_users = set()
last_message_id = {}
temp_pairs = {}  # Временные пары для выбора
...
async def show_notification_status(chat_id, status):
    """Показывает сообщение о включении/выключении на 2 секунды"""
...
async def handle_callback(callback_query):
    ...
    if data == "back_main":
        ...
        # Отменяем изменения - возвращаем сохраненные пары
        ...
        # Показываем статус включения/выключения
        ...
        # Копируем текущие пары во временные
