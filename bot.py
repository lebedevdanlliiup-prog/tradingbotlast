...
def get_main_menu_keyboard(mode, threshold, notifications_on=True):
    ...
    # Добавляем 🔸 только к выбранному режиму
    for row in buttons:
        for btn in row:
            btn_text = btn["text"]
            if "Strong" in btn_text and mode == "Strong":
                btn["text"] = "🔸 Strong"
            elif "Meme" in btn_text and mode == "Meme":
                btn["text"] = "🔸 Meme"
            elif "All" in btn_text and mode == "All":
                btn["text"] = "🔸 All"
            elif "Strong" in btn_text and mode != "Strong":
                btn["text"] = "Strong"
            elif "Meme" in btn_text and mode != "Meme":
                btn["text"] = "Meme"
            elif "All" in btn_text and mode != "All":
